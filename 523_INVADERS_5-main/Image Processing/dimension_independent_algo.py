...
if __name__ == "__main__":
    image1_path = "sbi fake.jpg"
    image2_path = "sbi original.jpg"
...
if __name__ == "__main__":
    image1_path = r"sbi fake.jpg"
    image2_path = r"sbi original.jpg"
...
if __name__ == "__main__":
    image1_path = "sbi original.jpg"
    image2_path = "sbi fake.jpg"
...
if __name__ == "__main__":
    # Load images in grayscale mode
    image1 = cv2.imread("sbi original.jpg", cv2.IMREAD_GRAYSCALE)
    image2 = cv2.imread("sbi fake.jpg", cv2.IMREAD_GRAYSCALE)
...
if __name__ == "__main__":
    # Load two images
    img1 = cv2.imread("sbi original.jpg")
    img2 = cv2.imread("sbi fake.jpg")
